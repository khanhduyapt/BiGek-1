...
double FIBO = 1.618;
double AMP_TP_L1 = 6.0;
double AMP_TP_Lx = AMP_TP_L1*AMP_TP_L1;
      ...
      if((global_min_entry_buy>0) && (global_min_entry_buy-AMP_TRADE>ask)
         && IS_CYCLE_BUY && CanOpenDCA(symbol,PERIOD_M15,last_time_buy))
        {
         ...
         bool opened_buy = //Open_Position(symbol,TREND_BUY,vol,0.0,0.0,comment_buy);
            m_trade.BuyLimit(vol,bid-0.5,symbol,0.0,0.0,0,0,comment_buy);
            ...
            if(count_buy>=START_EXIT_L)
              {
               ...
               m_trade.BuyLimit(vol,price_lowest_2d,symbol,0.0,0.0,0,0,comment_buy);
              }
