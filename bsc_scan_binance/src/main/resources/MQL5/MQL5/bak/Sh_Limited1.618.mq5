...
//string trend_h4=get_trend_by_stoc2(symbol,PERIOD_H4,24,12,9,1);

   double open_h4c0 = iOpen(symbol,PERIOD_H4,0);
...
//if(is_same_symbol(trend_h4,TREND_SEL))
//   IS_CYCLE_BUY=false;
//if(is_same_symbol(trend_h4,TREND_BUY))
//   IS_CYCLE_SEL=false;
//---------------------------------------------------------------------------------------------------------
//---------------------------------------------------------------------------------------------------------
//---------------------------------------------------------------------------------------------------------
   ...
   if((profit_buy+profit_sel+FIXED_SL)<0)
     {
      ...
      Alert("STOP_LOSS    " + symbol + "    Profit:"+ (string)(int)(profit_buy+profit_sel) + "$");
      return;
     }
...
//---------------------------------------------------------------------------------------------------------
   if(IS_CYCLE_BUY && (count_buy==0) && (Trend_H4C0==TREND_BUY))
     {
      count_buy=1;
   ...
   if(IS_CYCLE_SEL && (count_sel==0) && (Trend_H4C0==TREND_SEL))
     {
      count_sel=1;
...
//---------------------------------------------------------------------------------------------------------
   if(count_buy>0)
     {
      //IS_CYCLE_BUY &&
      if((global_min_entry_buy>0) && (global_min_entry_buy-AMP_TRADE>ask) && (Trend_H4C0==TREND_BUY) && (Trend_M5C1==TREND_BUY))
        {
         count_buy+=1;
...
//---------------------------------------------------------------------------------------------------------
   if(count_sel>0)
     {
      //IS_CYCLE_SEL &&
      if((global_max_entry_sel>0) && (global_max_entry_sel+AMP_TRADE<bid) && (Trend_H4C0==TREND_SEL) && (Trend_M5C1==TREND_SEL))
        {
         count_sel+=1;
