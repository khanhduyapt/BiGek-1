...
int GetEntrySignal()
  {
   ...
   double ind0val2  = iMACD(NULL, 0, Ind0Param0, Ind0Param1, Ind0Param2, PRICE_CLOSE, MODE_MAIN, 2);
   bool   ind0long  = ind0val1 > ind0val2 + sigma;
   bool   ind0short = ind0val1 < ind0val2 - sigma;

   // Commodity Channel Index (Typical, 18), Level: 7
...
void ManageClose()
  {
   // Moving Averages Crossover (Simple, Simple, 7, 23)
...
/*STRATEGY CODE {"properties":{"entryLots":1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":100,"takeProfit":100,"useStopLoss":false,"useTakeProfit":false,"isTrailingStop":false},"openFilters":[{"name":"MACD","listIndexes":[0,3,0,0,0],"numValues":[11,6,9,0,0,0]},{"name":"Commodity Channel Index","listIndexes":[5,5,0,0,0],"numValues":[18,7,0,0,0,0]}],"closeFilters":[{"name":"Moving Averages Crossover","listIndexes":[3,0,0,0,0],"numValues":[7,23,0,0,0,0]}]} */
