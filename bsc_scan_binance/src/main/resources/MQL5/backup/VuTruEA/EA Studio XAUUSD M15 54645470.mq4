...
static input double Entry_Amount =     0.10; // Entry lots
       input int    Stop_Loss    =     1435; // Stop Loss   (pips)
       input int    Take_Profit  =     5661; // Take Profit (pips)
...
static input string ___2______   = "------"; // --- Bollinger Bands ---
       input int    Ind2Param0   =       12; // Period
       input double Ind2Param1   =     3.07; // Deviation
static input string _Settings___ = "------"; // --- Expert Settings ---
static input int    Magic_Number = 54645470; // Magic Number
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":1,"stopLoss":1435,"takeProfit":5661,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Moving Average","listIndexes":[5,0,3,0,0],"numValues":[10,0,0,0,0,0]},{"name":"Accelerator Oscillator","listIndexes":[1,0,0,0,0],"numValues":[0,0,0,0,0,0]}],"closeFilters":[{"name":"Bollinger Bands","listIndexes":[3,3,0,0,0],"numValues":[12,3.07,0,0,0,0]}]} */
