...
static input string ___0______   = "------"; // --- Envelopes ---
       ...
       input double Ind0Param1   =     0.35; // Deviation %

static input string _Settings___ = "------"; // --- Expert Settings ---
static input int    Magic_Number = 81318217; // Magic Number
...
int GetEntrySignal()
  {
   // Envelopes (Close, Simple, 25, 0.35)
...
/*STRATEGY CODE {"properties":{"entryLots":0.3,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":30,"takeProfit":75,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Envelopes","listIndexes":[4,3,0,0,0],"numValues":[25,0.35,0,0,0,0]}],"closeFilters":[{"name":"Do not Exit","listIndexes":[0,0,0,0,0],"numValues":[0,0,0,0,0,0]}]} */
