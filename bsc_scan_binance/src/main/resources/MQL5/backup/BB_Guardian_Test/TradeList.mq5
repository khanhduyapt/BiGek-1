   ...
   if(nfile_history != INVALID_HANDLE)
     {
      ...
      FileWrite(nfile_history, "CLOSED :" + AppendSpaces((string)format_double(PL, 5)));
      FileWrite(nfile_history, "OPENING:" + AppendSpaces((string)format_double(OpenPositionsProfit(), 5)));
      FileWrite(nfile_history, "SUMMARY:" + AppendSpaces((string)format_double(loss, 5)));
      //--------------------------------------------------------------------------------------------------------------------
