...
if __name__ == "__main__":
    ...
    # Kiểm tra tham số đầu vào từ dòng lệnh
    if len(sys.argv) != 4:
        print("Usage: python main.py <Market> <Symbol> <Interval>")
        print("Example: python main.py HOSE QCG 1H")
    ...
    if isinstance(data, pd.DataFrame):
        # Tạo file tên dựa trên thông tin đầu vào
